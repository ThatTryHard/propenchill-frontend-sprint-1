  ...
  <DashboardLayout>
    ...
    <div class="p-8 flex flex-col gap-8 h-full font-sans bg-[var(--app-bg)]">
      ...
      <div class="flex flex-col gap-4">
        ...
        <div>
          <h1 class="text-[length:var(--app-page-title-font)] font-bold text-[var(--app-heading)]">Edit Wali Murid</h1>
          <p class="mt-1 text-[length:var(--app-page-subtitle-font)] text-[var(--app-muted)]">Perbarui data akun wali murid</p>
        </div>
      </div>
