...
<template>
  <DashboardLayout>
    ...
    <section
      class="
        min-h-full bg-[var(--app-bg)] px-5 py-5
    ...
    >
      <div class="mx-auto max-w-4xl">
        ...
        <div
          class="
            mb-5 overflow-hidden rounded-[24px]
            border border-[var(--app-card-border)]
            bg-[var(--app-card)] p-5 shadow-sm
          "
        >
          <h1
            class="
          ...
          <p
            class="
              mt-1 text-[length:var(--app-font-xs)]
          ...
          <div class="grid gap-4 lg:grid-cols-[0.85fr_1.45fr]">
            ...
            <VCard paddingClass="p-4">
              <div class="flex flex-col items-center text-center">
                <div
                  class="
                    relative mb-4 flex h-28 w-28 items-center justify-center
                    rounded-full bg-[var(--app-card)] shadow-inner
                    ring-8 ring-[var(--app-card)]
                  "
                >
                  <div
                ...
                <div class="flex w-full flex-col gap-3 text-left">
                  <div class="flex items-center gap-3">
                    ...
                    <p
                      class="
                        truncate text-[length:var(--app-font-xs)]
                        leading-[1.5] text-[var(--app-muted)]
                      "
                    >
            ...
            <VCard paddingClass="p-4">
              ...
              <div
                class="
                  overflow-hidden rounded-2xl border border-[var(--app-card-border)]
                  bg-[var(--app-card)]
                "
              >
                <div
                  class="
                    grid grid-cols-[minmax(150px,0.75fr)_1.25fr]
                    items-center gap-3 border-b border-[var(--app-card-border)]
                    px-[14px] py-[11px]
                    max-[768px]:grid-cols-1 max-[768px]:gap-[6px]
                  "
                >
                  <div
                    class="
                ...
                >
                  ...
                  <p
                    class="
                      break-all text-[length:var(--app-font-xs)]
                      font-semibold leading-[1.4] text-[var(--app-heading)]
                    "
                  >
                    {{ displayValue(profile.email) }}
                ...
                <div
                  class="
                    grid grid-cols-[minmax(150px,0.75fr)_1.25fr]
                    items-center gap-3 px-[14px] py-[11px]
                    max-[768px]:grid-cols-1 max-[768px]:gap-[6px]
                  "
                >
                  <div
            ...
            <div class="grid gap-3 md:grid-cols-3">
              ...
              >
                ...
                <div>
                  ...
                  <p
                    class="
                      mt-0.5 text-[length:var(--app-font-md)]
              ...
              >
                ...
                <div>
                  ...
                  <p
                    class="
                      mt-0.5 text-[length:var(--app-font-md)]
                      font-bold leading-[1.3] text-[var(--app-accent)]
                    "
                  >
                    {{ profile.status_akun }}
                  </p>
    ...
    >
      <div class="mt-2 flex w-full flex-col gap-4 text-left">
        <div
          v-if="editError"
          class="
            rounded-lg border border-[var(--app-danger-border)]
            bg-[var(--app-danger-bg)] p-3
            text-[length:var(--app-font-xs)]
            leading-[1.5] text-[var(--app-danger)]
          "
        >
          {{ editError }}
        </div>
