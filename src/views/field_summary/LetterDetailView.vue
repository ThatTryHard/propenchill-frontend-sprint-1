<template>
  <DashboardLayout>
    ...
    <div class="p-8 font-['Plus_Jakarta_Sans'] bg-[#F8FBF9] min-h-screen">
      <div class="mb-8">
        <p class="text-[14px] text-[#64748B] font-medium">
          Dashboard Ringkasan Surat Bidang Akademik > 
          <span class="text-[#111827] font-bold">Detail Informasi Surat</span>
        </p>
      </div>

      <div class="bg-white rounded-[24px] border border-[#E5E7EB] shadow-sm p-8">
        <div class="mb-10">
          <h1 class="text-[24px] font-bold text-[#111827]">Detail Informasi Surat</h1>
          <p class="text-[#64748B] text-[14px]">Berikut detail informasi surat</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-y-10 gap-x-20">
          <div class="space-y-10">
            <div>
              <p class="text-[14px] font-bold text-[#111827] mb-1">No. Urut Tabel</p>
              <p class="text-[16px] text-[#64748B] font-medium">{{ letterData.nomor_agenda }}</p>
            </div>
            <div>
              <p class="text-[14px] font-bold text-[#111827] mb-1">Nomor Surat</p>
              <p class="text-[16px] text-[#64748B] font-medium">{{ letterData.nomor_surat }}</p>
            </div>
          </div>

          <div class="space-y-10">
            <div>
              <p class="text-[14px] font-bold text-[#111827] mb-1">Pengirim</p>
              <p class="text-[16px] text-[#64748B] font-medium">{{ letterData.pengirim }}</p>
            </div>
            <div>
              <p class="text-[14px] font-bold text-[#111827] mb-1">Tanggal Terima</p>
              <p class="text-[16px] text-[#64748B] font-medium">{{ letterData.tanggal_terima }}</p>
            </div>
          </div>

          <div class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-x-20">
             <div>
                <p class="text-[14px] font-bold text-[#111827] mb-1">Perihal</p>
                <p class="text-[16px] text-[#64748B] font-medium">{{ letterData.perihal_detail }}</p>
             </div>
             <div>
                <p class="text-[14px] font-bold text-[#111827] mb-1">Klasifikasi Surat</p>
                <p class="text-[16px] text-[#64748B] font-medium">{{ letterData.klasifikasi }}</p>
             </div>
          </div>
        </div>
      </div>
